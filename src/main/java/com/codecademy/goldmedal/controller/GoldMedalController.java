...
@RestController
@RequestMapping("/countries") // This annotation maps HTTP requests to handler methods of MVC and REST controllers
public class GoldMedalController {
    ...
    @GetMapping("/{country}")  //getCountryDetails
    public CountryDetailsResponse getCountryDetails(@PathVariable String country) {
        String countryName = WordUtils.capitalizeFully(country);
        return getCountryDetailsResponse(countryName);
    }

    @GetMapping("/{country}/medals")    //getCountryMedalsList by country by sort_by and ascending
